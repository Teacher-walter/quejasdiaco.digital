...
<body>
	...
	<div class="espacio container-fluid">
		...
		<center><a href="<?=$base_url?>/usuario/listar_pdf" class="btn btn-primary btn-sm" ><i class="fa fa-download"></i> Descargar listado</a></center>
		<br>
		<div>
		    ...
		    <tbody >
		       <?php
		         ...
		         <tr>
		          ...
		          <td class='text-center'><a class="btn btn-warning btn-sm" href="<?=$base_url?>/usuario/restaurar_datos/<?php echo $a['id_usuario'] ;?>"><i class="fa fa-key"></i></a></td>
