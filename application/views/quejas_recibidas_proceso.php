...
<body>
	...
	<div class="container-fluid espacio">
		<h3 class="text-center"><i class="fa fa-comments"></i> Ingreso de Quejas</h3>
		<h6>Cantidad de quejas ingresados al sistema: <strong style="color: red; font-weight: bold;"><?php echo $registros; ?></strong></h6>
		<section>
		    ...
		    <tbody >
		       <?php
		         ...
		         <tr>
		          ...
		          <td class='text-center'><a class='btn btn-primary btn-sm' data-toggle="modal" data-target="#updateQueja" onclick="obdatosIdmodificar('<?php echo $a['no_queja'] ;?>')"><i class="fa fa-user-edit"></i></a></td>
		         </tr>
		      <?php } ?>
		    </tbody>
		    </table>
	  ...
	  <div class="modal-dialog modal-lg">
	    <div class="modal-content">
	      <div class="modal-header" style="background-color:#000979; color: #fff;">
	        <h5 class="modal-title" id="exampleModalLabel">Datos generales de la queja</h5>
	      ...
	      <div class="modal-body">
	        ...
	        <br>
	          <div class="form-row">
	            ...
	            <div class="col-sm-6 col-6">
	                <label for="cantidad" class="result">Actualizar avance del registro</label>
	                <select class="custom-select ford" name="estado" required>
				        <option selected disabled value="">Seleccionar</option>
				        <option value="B">Recibido</option>-
				        <option value="A">No Recibido</option>
				        <option value="F">Dar Baja</option>
				     </select>
				      <div class="invalid-feedback">Por favor seleccionar una opción.</div>
	        ...
	        <div class="form-row">
	            <div class="col-sm-12 col-12">
	                <label for="usuario">Empleado quién actualiza el registro:</label>
...
//obtener id dato selec
  ...
  function redlistar(){
  window.location.href='<?=$base_url?>/proceso/listarrecibidas';
};
