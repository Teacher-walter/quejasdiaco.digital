...
<body>
	...
	<div class="container-fluid espacio">
		...
		<h6 style="color:red; font-weight: bold;">Quejas sin solución: <strong style="color: #000; font-weight: bold;"><?php echo $registros; ?></strong></h6>
		<section>
		       ...
		       <?php
		         ...
		         <tr>
		          ...
		          <td class="text-center">
		          	<?php if ($a['estado'] == 'E') { ?>
		          		<p style="color: red; font-weight: bold;"><i class="fa fa-check"></i> Sin Solución</p>
		          		<?php } ?>
		          	</td>
	          ...
	          <div class="form-row">
	            ...
	            <div class="col-sm-6 col-6">
	                ...
	                <select class="custom-select ford" name="estado" required>
				        ...
				        <option value="E">No dar de baja</option>
				        <option value="B">Volver a activar la queja</option>
				     </select>
