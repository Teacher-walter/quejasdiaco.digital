...
<body>
	...
	<div class="container-fluid espacio">
		...
		<h6 style="color: green; font-weight: bold;">Cantidad de quejas aceptados: <strong style="color: red; font-weight: bold;"><?php echo $registros; ?></strong></h6>
		<section>
	          ...
	          <div class="form-row">
	            ...
	            <div class="col-sm-6 col-6">
	                ...
	                <select class="custom-select ford" name="estado" required>
				        ...
				        <option value="D">Solucionado</option>
				        <option value="E">Sin Solución</option>
				     </select>
...
//obtener id dato selec
  ...
  window.location.href='<?=$base_url?>/proceso/listaraceptadas';
};
